...
| 3. Course System | Language, Course, Lesson, Vocabulary, Grammar — Admin CRUD + User view + Lesson learning | 🔄 Đang thực hiện — Language + Course + Lesson + Vocabulary + Grammar/LessonVocabulary + Enroll/Complete Lesson xong, còn Tag/VocabularyTag/VocabularyRelation (XP/Streak khi hoàn thành Lesson vẫn hoãn đúng lịch Giai đoạn 7) |
...
Còn lại của Giai đoạn 3: `Tag`/`VocabularyTag`/`VocabularyRelation`.

Bước tiếp theo: `Tag` + `VocabularyTag` + `VocabularyRelation` (phụ thuộc `Vocabulary`) — hoàn thành xong sẽ khép lại toàn bộ Giai đoạn 3.
