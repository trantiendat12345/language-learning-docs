...
Bước tiếp theo: **Vocabulary Learning** (trang học từ vựng theo chế độ xem danh sách/luyện tập, tách riêng khỏi Flashcard — Flashcard là bước kế tiếp sau).
