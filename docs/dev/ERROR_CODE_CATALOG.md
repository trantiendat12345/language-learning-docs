...
| `AUTH_ACCOUNT_DISABLED` | 401/403 | TC-AUTH-011 |
| `AUTH_ACCOUNT_LOCKED` | 401/403 | TC-AUTH-012 |
| `AUTH_TOKEN_EXPIRED` | 401 | TC-AUTH-017 |
| `AUTH_TOKEN_INVALID` | 401 | TC-AUTH-018 |
| `AUTH_TOKEN_ALREADY_USED` | 400/401 | TC-AUTH-024 (reset password token dùng lại) |
| `AUTH_USERNAME_TAKEN` | 400/409 | TC-AUTH-002 |
| `AUTH_EMAIL_TAKEN` | 400/409 | TC-AUTH-003 |
